...
<nav class="navbar navbar-default">
  <div class="container-fluid">
	...
	<div class="jumbotron">
	<form action="/Amazon/admin/articoli/" method="POST">
	...
	<input type="text" class="form-control" name="name" placeholder="NomeArticolo" value="">
	<input type="number" class="form-control" name="prezzo" placeholder="PrezzoArticolo" value="">	
	<input type="number" class="form-control" name="quantita" placeholder="QuantitaArticolo" value="">	
	<input type="text" class="form-control" name="immagineUrl" placeholder="ImmagineUrlArticolo" value="">	
